...
async def update_profile(
    ...
    source_lang_id = updated_detail.source_language_id if updated_detail else None
    target_lang_id = updated_detail.target_language_id if updated_detail else None
    ...
    # Create new access token with updated name + language IDs
